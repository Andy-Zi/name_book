				...
				\begin{tikzpicture}[remember picture,overlay]
					...
					\foreach \name [count=\i] in \Girls {
						...
						\ifthenelse{\textlength > 0}{%
							...
							\node[anchor=west] at ([xshift=.28cm,yshift=-0.825cm-\i*0.825cm]current page.north west) {\shrinktofit{0.9cm}{\fontspec{Coming Soon}\textcolor{white}\name}};
						...
						\hyperlink{Girls\i}{
							\fill [white, opacity=0] ([xshift=.25cm,yshift=-.5cm-\i*0.825cm]current page.north west) rectangle ([xshift=1.5cm,yshift=-1.25cm-\i*0.825cm]current page.north west);
						}
					}
					\foreach \name [count=\i] in \Boys {
						...
						\ifthenelse{\textlength > 0}{%
							% The text is longer than 0 characters and contains \mytextlength\ characters.%
							\node[anchor=west] at ([xshift=-1.18cm,yshift=-0.825cm-\i*0.825cm]current page.north east) {\shrinktofit{0.9cm}{\fontspec{Coming Soon}\textcolor{white}\name}};
							% Place a node with the hyperlink over the rectangle. The hyperlink target is now dynamically generated.
						}{%
							% The text is empty.%
						}
						...
						\hyperlink{Boys\i}{
							\fill [white, opacity=0] ([xshift=-.25cm,yshift=-.5cm-\i*0.825cm]current page.north east) rectangle ([xshift=-1.5cm,yshift=-1.25cm-\i*0.825cm]current page.north east);
						}
					}
					...
					\ifthenelse{\NOT\equal{#1}{}}{
						...
						% \node[anchor=west] at ([xshift=.25cm,yshift=-0.825cm-\i*0.825cm]current page.north west) {\hyperlink{Girls\i}{\fontspec{Coming Soon}\textcolor{white}\name}};
						\StrLen{\name}[\textlength]
						% Check if the text is longer than 0 characters
						\ifthenelse{\textlength > 0}{%
							\node[anchor=west] at ([xshift=.28cm,yshift=-0.825cm-#1*0.825cm]current page.north west) {\shrinktofit{1.15cm}{\fontspec{Coming Soon}\textcolor{white}\name}};
							% Place a node with the hyperlink over the rectangle. The hyperlink target is now dynamically generated.
						}{%
							% The text is empty.%
						}
						% \hyperlink{Girls#1}{
						% 	\fill [pink, opacity=1] ([xshift=.25cm,yshift=-.5cm-#1*0.825cm]current page.north west) rectangle ([xshift=1.5cm,yshift=-1.25cm-#1*0.825cm]current page.north west);
						% }
						% \node[anchor=west, minimum height=0.75cm, minimum width=1.2cm] at ([xshift=0cm,yshift=-0.875cm-#1*0.825cm]current page.north west) {\hyperlink{Girls\i}{\phantom{\name}}};
					}{
						...
						\ifthenelse{\NOT\equal{#2}{}}{
							...
							% Check if the text is longer than 0 characters
							\ifthenelse{\textlength > 0}{%
								\node[anchor=west] at ([xshift=-1.43cm,yshift=-0.825cm-#2*0.825cm]current page.north east) {\shrinktofit{1.15cm}{\fontspec{Coming Soon}\textcolor{white}\name}};
								% Place a node with the hyperlink over the rectangle. The hyperlink target is now dynamically generated.
							}{%
								% The text is empty.%
							}
							% \node[anchor=west, minimum height=0.75cm, minimum width=1.2cm] at ([xshift=-1.2cm,yshift=-0.875cm-\i*0.825cm]current page.north east) {\hyperlink{Boys\i}{\phantom{\name}}};
							% \hyperlink{Boys#2}{
							% 	\fill [pink, opacity=1] ([xshift=-.25cm,yshift=-.5cm-#2*0.825cm]current page.north east) rectangle ([xshift=-1.5cm,yshift=-1.25cm-#2*0.825cm]current page.north east);
							% }
						}{
							% Both parameters are empty. % Both are empty
						}
					}
				\end{tikzpicture}
			}
