				...
				\begin{tikzpicture}[remember picture,overlay]
					...
					\foreach \name [count=\i] in \Girls {
						...
						\ifthenelse{\textlength > 0}{%
							...
							\node[anchor=west] at ([xshift=.28cm,yshift=-0.825cm-\i*0.825cm]current page.north west) {\shrinktofit{0.9cm}{\ComingSoon\textcolor{white}\name}};
					...
					\foreach \name [count=\i] in \Boys {
						...
						\ifthenelse{\textlength > 0}{%
							% The text is longer than 0 characters and contains \mytextlength\ characters.%
							\node[anchor=west] at ([xshift=-1.18cm,yshift=-0.825cm-\i*0.825cm]current page.north east) {\shrinktofit{0.9cm}{\ComingSoon\textcolor{white}\name}};
							% Place a node with the hyperlink over the rectangle. The hyperlink target is now dynamically generated.
						}{%
							% The text is empty.%
						}
					...
					\ifthenelse{\NOT\equal{#1}{}}{
						...
						% \node[anchor=west] at ([xshift=.25cm,yshift=-0.825cm-\i*0.825cm]current page.north west) {\hyperlink{Girls\i}{\ComingSoon\textcolor{white}\name}};
						\StrLen{\name}[\textlength]
						% Check if the text is longer than 0 characters
						\ifthenelse{\textlength > 0}{%
							\node[anchor=west] at ([xshift=.28cm,yshift=-0.825cm-#1*0.825cm]current page.north west) {\shrinktofit{1.15cm}{\ComingSoon\textcolor{white}\name}};
							% Place a node with the hyperlink over the rectangle. The hyperlink target is now dynamically generated.
						}{%
							% The text is empty.%
						}
						...
						\ifthenelse{\NOT\equal{#2}{}}{
							...
							% Check if the text is longer than 0 characters
							\ifthenelse{\textlength > 0}{%
								\node[anchor=west] at ([xshift=-1.43cm,yshift=-0.825cm-#2*0.825cm]current page.north east) {\shrinktofit{1.15cm}{\ComingSoon\textcolor{white}\name}};
								% Place a node with the hyperlink over the rectangle. The hyperlink target is now dynamically generated.
							}{%
								% The text is empty.%
							}
